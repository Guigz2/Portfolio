  ...
  if (!state) {
    return (
      <section className="relative py-8 md:py-16">
        <div className="mx-auto w-[min(55vw,480px)] md:w-[min(70vw,480px)] aspect-square rounded-full bg-white shadow-[0_20px_60px_rgba(0,0,0,0.12)] ring-1 ring-black/10" />
      </section>
    )
  }
  ...
  return (
    <section className="relative py-6 md:py-12">
      ...
      <div className="mx-auto max-w-[600px] px-4">
        <div className="flex flex-col items-center text-center gap-1 mb-3 md:mb-6">
          <div className="tracking-[.2em] text-[clamp(10px,2vw,16px)] text-black">
            BASED IN PARIS
          </div>
          <div className="tracking-[.2em] text-[clamp(8px,1.4vw,11px)] text-zinc-400">
            MY CURRENT LOCAL TIME
          </div>
          <div className="tracking-[.15em] text-[clamp(9px,1.4vw,12px)] text-zinc-600">
            {state.status}
          </div>
        </div>
      </div>
      ...
      <div className={`hidden md:block absolute left-6 bottom-1/2 translate-y-1/2 text-4xl md:text-5xl ${dot.className}`}>
        {state.timeText}
      </div>
      <div className={`hidden md:block absolute right-6 bottom-1/2 translate-y-1/2 text-4xl md:text-5xl ${dot.className}`}>
        {state.tz}
      </div>

      {/* horloge */}
      <div className="mx-auto max-w-[600px] px-4">
        <div className="mx-auto w-[min(55vw,480px)] md:w-[min(70vw,480px)] aspect-square rounded-full bg-white shadow-[0_20px_60px_rgba(0,0,0,0.12)] ring-1 ring-black/10 grid place-items-center">
