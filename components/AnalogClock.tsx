...
export default function AnalogClock() {
  ...
  return (
    <section className="relative py-24">
      ...
      {/* horloge */}
      <div className="mx-auto w-[min(88vw,720px)] aspect-square rounded-full bg-white shadow-[0_20px_60px_rgba(0,0,0,0.12)] ring-1 ring-black/10 grid place-items-center">
